<template>
  <div id="container">
    ...
    <div class="content robpin">
      ...
      <p>Once you have it adjusted to your preference, you only slip it in and out of the socket when you are packing and unpacking the bass. When detached, it might even fit into the accessory pocket of your bag! The set screw in your socket needn't even be especially tight. The weight of the bass goes onto the "Bottom Block Rest", keeping the bracket from turning.</p>
      <h2 class="bold">Height and angle adjustment:</h2>
      <p>The RobPin comes with three interchangeable rods of different lengths, giving it a good range of height adjustment. The angle of the pin going to the floor can be set at 25&deg;, 35&deg;, or 45&deg;. If your endpin is not 10mm, then adapters are available. If it doesn't come out of the socket, then you naturally need to remove the holding pin, or have your luthier do it.</p>
    </div>
    ...
    <div class="blue">
      <div class="content other">
        ...
        <p>This clamp is an improvement over an existing idea. A luthier friend has been bugging me for years to develop this, but it was not until I used one that I understood how useful they are.
          The back plate turns 9&deg; left or right, but holds a right angle in the vertical axis. Made of extremely hard Bamboo plywood with stainless screw and rods, and the 1.5mm silicone pads are non-stick and easy to keep clean. 26cm maximum opening.
          The advantage over spool clamps is that they don't twist when tightening, conform to the tapers, and cover a wider area, so you get a seam closed way faster than before!</p>
      </div>
    </div>
...
<style>
  ...
  .content .rslides li img {
    ...
    height: 100%;
    max-height: 480px; }
  .content .rslides li:after {
    height: 0; }
  .content.robpin h2 {
    font-size: 1em;
    margin: 0 0 3px 0; }
  .content.robpin .rslides li {
    min-height: 540px; }
  .content .clamps {
  ...
  .content .clamps img {
    border: none; }
  .content .clamps .mobile {
    display: none; }
  @media only screen and (max-width: 736px) {
    .content .clamps .rslides {
      display: none; }
    .content .clamps .mobile {
      display: flex;
      ...
      align-items: center;
      width: 100%; }
    .content .clamps .mobile img {
      max-width: 100%; } }
  .content.wood-endpins img {
    height: auto;
    max-width: 80%; }
  @media only screen and (min-width: 320px) and (max-width: 518px) {
    .content.wood-endpins img {
